...
! function(exports) {
    ...
    var model_dimension = function() {
        ...
        var dimension = function(object) {
            ...
            return multiple ? dimension.value.map(function(d) {
                return accessor.call(dimension, object[d.key]); }) : accessor.call(dimension, object[dimension.value[0].key]);
        };
        ...
        dimension.type = function() {
            ...
            return multiple ? dimension.value.map(function(d) {
                return d.type }) : dimension.value[0].type;
        };
    ...
    raw.models.set('graph', function() {
        ...
        graph.map(function(data) {
            ...
            l.forEach(function(d) { d.source = n.indexOf(d.source);
    ...
    raw.divergingRange = function(n) {
        return d3.range(n).map(function(d) {
            return d3.hsl(360 / n * d, 0.4, 0.58).toString();
        });
    };

    raw.foreground = function(color) {
        return d3.hsl(color).l > 0.5 ? "#222222" : "#ffffff";
    };
